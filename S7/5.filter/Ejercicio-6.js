...
const lolPlayers = streamers.filter(streamer => {
    const isLolero = streamer.gameMorePlayed.toLowerCase().includes('legends');
...
//const lolPlayers = streamers.filter(streamer => streamer.gameMorePlayed.toLowerCase().includes('Legends'.toLowerCase()) ? streamer.gameMorePlayed.toUpperCase(): streamer.gameMorePlayed);
